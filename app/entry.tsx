...
export default function Entry() {
  ...
  const clockInChoices = useMemo(() => timeChoices(clockIn), [clockIn]);
  const clockOutChoices = useMemo(() => timeChoices(clockOut), [clockOut]);
  ...
  function confirmDelete() {
    ...
    Alert.alert(
      "Delete time entry?",
      "This will permanently remove this saved time entry.",
      [
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.top}>
          ...
          <Text style={styles.subtitle}>
            Tap each field instead of typing dates and times.
          </Text>
        </View>
        ...
        <View style={styles.timeRow}>
          <View style={styles.timeColumn}>
            <SelectField
              label="Clock In"
              value={formatTime12h(clockIn)}
              onPress={() =>
                openPicker("Clock In", clockIn, clockInChoices, setClockIn)
              }
              styles={styles}
            />
          </View>
          ...
          <View style={styles.timeColumn}>
            <SelectField
              label="Clock Out"
              value={formatTime12h(clockOut)}
              onPress={() =>
                openPicker("Clock Out", clockOut, clockOutChoices, setClockOut)
              }
              styles={styles}
            />
          </View>
